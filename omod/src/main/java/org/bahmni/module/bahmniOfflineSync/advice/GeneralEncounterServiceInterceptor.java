...
public class GeneralEncounterServiceInterceptor  implements MethodInterceptor {
    private static final String ENCOUNTER_URL = "/openmrs/ws/rest/v1/bahmnicore/bahmniencounter/%s?includeAll=true";

    private final String category = "Encounter";
    private AtomFeedSpringTransactionManager atomFeedSpringTransactionManager;
    private EventService eventService;

    public GeneralEncounterServiceInterceptor() {
    ...
    public GeneralEncounterServiceInterceptor(AtomFeedSpringTransactionManager atomFeedSpringTransactionManager, EventService eventService) {
    ...
    private List<String> operations() {
        return asList("saveEncounterForOfflineSync");
    }
