...
public class CureIdBasedSyncStrategy extends AbstractOfflineSyncStrategy {
    private static Logger logger = Logger.getLogger(CureIdBasedSyncStrategy.class);
    ...
    public CureIdBasedSyncStrategy() {
    ...
    protected String evaluateFilterForPatient(String uuid) {
    	String patientsToSync = Context.getAdministrationService().getGlobalProperty("bahmniconnect.patientsToSync");
        ...
        if (patient != null) {
            ...
            if (identifier != null && !Arrays.asList(patientsToSync.split(",")).contains(identifier.getIdentifier())) {
                return null;
            }
    ...
    private PatientIdentifier getPatientIdentifier(Patient patient) {
    	String identifierTypeName = Context.getAdministrationService().getGlobalProperty("bahmniconnect.patientIdentifierType");
